  ...
  <div class="row">
      <div class="col-md-12">    
          <div class="card card-primary">
              ...
              <form role="form" method="POST" name="plan_form" action="<?=base_url();?>plan/add" class="plan-form" id="planForm">
              <div class="card-body">
              ...
              <div class="col-lg-6">
                  ...
                  <input type="text" class="form-control" id="PlanTitle" name="plan_title" placeholder="" required>
                  </div>
                  ...
                  <input type="text" class="form-control" id="PlanID" name="plan_id" value="" placeholder="" required>
                  </div>                  
              </div>
              <div class="col-lg-6">
              <div class="form-group">
